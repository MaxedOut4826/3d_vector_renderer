...
from render_pipeline.rendering_engine import Renderer
...
def main() -> None:
    """
    Forcing UTF-8 allows the special ASCII characters to show in the terminal for certain environments like pypy
    """
    force_utf8()
